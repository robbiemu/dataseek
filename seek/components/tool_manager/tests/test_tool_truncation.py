...
from seek.components.tool_manager.utils import _truncate_response_for_role
...
class TestToolTruncation(unittest.TestCase):
    ...
    def test_truncate_response_for_role_no_truncation(self):
        ...
        with patch("seek.components.tool_manager.utils.get_active_seek_config") as mock_get_cfg:
